...
<div class="product-archive-main">
   ...
   <div class="pab-pagination">
      ...
      <div class="pab-pagination-arrows">
         <button class="prev-btn btn-dark-blue-blue" aria-label="Previous"><svg width="21" height="20" viewBox="0 0 21 20" fill="none" xmlns="http://www.w3.org/2000/svg">
<path d="M8.55382 15.4445L3.10937 10M3.10937 10L8.55382 4.55557M3.10937 10L17.1094 10" stroke="white" stroke-width="1.67" stroke-linecap="round" stroke-linejoin="round"/>
         ...
         <button class="next-btn btn-dark-blue-blue" aria-label="Next"><svg width="21" height="20" viewBox="0 0 21 20" fill="none" xmlns="http://www.w3.org/2000/svg">
