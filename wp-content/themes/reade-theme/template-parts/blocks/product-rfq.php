...
',
                    'width' => '100%',
                    'extra_classes' => array('tf-dropdown-hidden', 'product-rfq-select')
                );

                if (!empty($pattrs['type']->get_data()['options'])) {
                    $options = $pattrs['type']->get_data()['options'];
        ...
        ?>
        <a href="#" class="btn-blue-dark-blue btn-arrow">
            <?php echo $buttontext; ?>
