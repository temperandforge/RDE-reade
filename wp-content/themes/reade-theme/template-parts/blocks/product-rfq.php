...
<path d="M1.81692 83.4166L30.5034 66.5397L59.1523 83.4166L30.4873 100.294V137.51L1.81692 120.638V83.4166ZM1.81692 83.4166L30.4873 100.294L59.1523 83.4166V120.638L30.4873 137.51" stroke="#AEE3F0" stroke-width="2" stroke-linejoin="round"/>
    ...
    <div class="product-rfq-bottom">
        ...
        if (!empty($options['rfq_bottom_button'])) {
            ?>
            <a href="<?php echo !empty($options) && !empty($options['rfq_bottom_button']) && !empty($options['rfq_bottom_button']['url']) ? $options['rfq_bottom_button']['url'] : ''; ?>" class="btn-white-light-blue btn-arrow" <?php if (!empty($options) && !empty($options['rfq_bottom_button']) && !empty($options['rfq_bottom_button']['target']) && $options['rfq_botton_button']['target'] == '_blank') { ?>target="_blank"<?php } ?>>
