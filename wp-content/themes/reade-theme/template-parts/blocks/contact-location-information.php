      ...
      <div class="contact-information--wrap">
         <div class="contact-information--locations">
            <?php foreach ($fields['locations'] as $index => $location) : ?>
               <h2>
                  <button class="<?php echo ($index % 2 != 0) ? 'btn' : 'btn-blue-dark-blue'; ?>" aria-expanded="<?php echo ($index == 0) ? 'true' : 'false'; ?>" aria-controls="location<?php echo $index + 1; ?>" id="location<?php echo $index + 1; ?>id">
         ...
         <div class="contact-information--content">
            <?php foreach ($fields['locations'] as $index => $location) : ?>
               <div class="contact-information--set <?php echo ($index == 0) ? 'active' : null; ?>" aria-hidden="<?php echo ($index == 0) ? 'false' : 'true'; ?>" id="location<?php echo $index + 1; ?>" aria-labelledby="location<?php echo $index + 1; ?>id" role="region">
                  <figure>
