            ...
            <div class="tools-cta-bottom-container">
                ...
                foreach ($fields['categories'] AS $category) {
                    ...
                    <div class="tools-cta-bottom-category">
                        <h2 class="tools-category"><?php echo $term->name; ?></h2>
                        <?php
                        ...
                        if (!empty($cfields['archive_page_link'])) {
                            ?>
                            <a class="btn-blue-dark-blue btn-arrow" href="<?php echo $cfields['archive_page_link']['url']; ?>">
                            <?php echo $cfields['archive_page_link']['title']; ?>
