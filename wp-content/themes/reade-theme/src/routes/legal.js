...
function handleMobileNav() {
	...
	Array.from( document.querySelectorAll( '.pseudo-select-menu li' ) ).forEach( ( el ) => {
...
function generateInPageNavigation() {
	const $nav = $( '.in-page-nav-desktop nav, .in-page-nav-mobile nav' );
	...
	// laod as disabled for listening to page scroll until proper anchor link section associated is scrolled to
	let enableScrolling = false;
	setTimeout( () => {
		enableScrolling = true;
	}, 1000 ); //time-based substitution
